...
A_base = 5e-3;   % amplitude
f_base = 5;      % frequency (Hz)

omega = 2*pi*f_base;

yb_dd = @(t) -A_base*omega^2*sin(omega*t);
...
function dydt = archEOM(t,a_vec,M11,M22,K11,K22,G11,G22,gamma1,gamma2,P,A,E,L,rho,modal_gamma,yb_dd)
